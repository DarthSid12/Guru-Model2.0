...
from model_coords_attention import ModelCoordsAttention
...
def main():
    ...
    # ----------------------------- Model ----------------------------
    model = ModelCoordsAttention(size=180, num_classes=num_classes, pretrained=False, T=args.temperature).to(device)
